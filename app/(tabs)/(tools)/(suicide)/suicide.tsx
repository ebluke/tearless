...
import { getQuestions } from "@/lib/screeningQuestions/suicideQuestions";
      ...
      {shouldShowButton && (
        <Animated.View style={[styles.floatingButtonContainer, { opacity }]}>
          <Pressable
            ...
            onPress={() => {
              router.push("/(tabs)/(tools)/(suicide)/results");
            }}
          >
...
export default observer(SuicideScreener);
