...
class DepressionDataStore {
  totalScore = 0;
  questionCount = 9; // future case -> get this to be automated not manual
  finished = false;
  optionalNotes = "";
  ...
  saveResults() {
    const result = {
      ...
      clientName: "paul frankfurt",
      screenTool: "depression",
...
export const DepressionStore = new DepressionDataStore();
